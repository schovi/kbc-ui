...
module.exports =
  ...
  ActionTypes: keyMirror
    ...
    INSTALLED_COMPONENTS_TEMPLATED_CONFIGURATION_EDIT_UPDATE_FROM_TEMPLATE: null
    INSTALLED_COMPONENTS_TEMPLATED_CONFIGURATION_EDIT_UPDATE_JOBS_STRING: null
    INSTALLED_COMPONENTS_TEMPLATED_CONFIGURATION_EDIT_UPDATE_MAPPINGS_STRING: null
