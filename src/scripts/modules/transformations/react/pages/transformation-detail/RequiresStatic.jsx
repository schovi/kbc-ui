...
export default React.createClass({
  ...
  transformation(transformationId) {
    return (
      <Link to="transformationDetail" params={{transformationId: transformationId, bucketId: this.props.bucketId}}>
  ...
  startEditButton() {
    return (
      <button className="btn btn-link" onClick={this.props.onEditStart}>
        <span className="kbc-icon-pencil"></span> Edit Required Transformations
      </button>
    );
  },
